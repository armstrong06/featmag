    ...
    def nested_rfecv(self,
        ...
        for i, data in enumerate(cv_outer.split(X)):
            ...
            if run_gridsearchcv_all_feats:
                gs_results_all, yhat_all = self.do_gridsearchcv(
                ...
                cv_mean_all, cv_std_all, params_all = self.get_gridsearchcv_best_results(
                    gs_results_all)
            ...
            cv_mean_best, cv_std_best, params_best = self.get_gridsearchcv_best_results(
                gs_results_best)
