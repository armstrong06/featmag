...
if __name__ == "__main__":
    ...
    arrival_catalog_1c = 'currentEarthquakeArrivalInformation1CWithGains.csv'
    ...
    arrival_catalog_df = arrival_catalog_1c_df.append(arrival_catalog_3c_df, ignore_index = True)
    # Regress on Ml
